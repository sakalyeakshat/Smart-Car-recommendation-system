...
This project uses the Indian Cars dataset from Kaggle, containing detailed records of vehicles across multiple budget segments, enriched with specs like Brand, Model, Price, Mileage, Safety Ratings, Seating, Fuel, and Transmission.
...
**Manual Dataset Expansion & Higher Budgets**
The base dataset originally contained only budget-friendly options under 20 Lakhs. To allow the recommendation engine to work across a wider price spectrum, we manually expanded the dataset by adding popular premium models and electric vehicles (such as the Kia EV9 at 130 Lakhs and the BYD Sealion 7 at 43 Lakhs). This enables the algorithm to test and return valid recommendations for higher-budget user profiles.
...
## Dataset Source
Dataset used, Indian Cars dataset.
